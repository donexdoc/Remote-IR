...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u"../../assets/icons/plus-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.addCommandBtn.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u"../../assets/icons/save-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.saveCommandBtn.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u"../../assets/icons/trash-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.deleteCommandBtn.setIcon(icon5)
...
#if QT_CONFIG(tooltip)
        self.receiveChangeBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Start/Stop", None))
#endif // QT_CONFIG(tooltip)
